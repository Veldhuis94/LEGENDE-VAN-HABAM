...
class MainMenu:
    ...
    def __init__(self):
        ...
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 1, onClick = onInventoryClick, txt="Inventaris"))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 2, onClick = onBattleSystemClick, txt="Gevecht"))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 6, onClick = onBoardRandomizerClick, txt="Bord randomizer"))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 4, onClick = onGameManualClick, txt="Spelregels"))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 7, onClick = onCreditsClick, txt="Credits"))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 5, onClick = onPlayernameClick, txt = 'Spelernamen'))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 3, onClick = onMarketClick, txt = 'Markt'))
        self.page.add(buttonTemplate.copy(y=buttonY + buttonMarginY * 0, onClick = onSpelverloopClick, txt = 'Spelverloop'))
    def draw(self):
       self.page.update()
       self.page.draw()
